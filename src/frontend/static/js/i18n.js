...
const I18N_DICT = {
  vi: {
    ...
    demo_hint_title: "Tài Khoản Mẫu Để Đánh Giá:",
    demo_admin_hint: "Quản trị: admin / Admin@123 (Tự chuyển hướng sang /admin)",
    demo_user_hint: "Người dùng: demo / Demo@123 (Tự chuyển hướng sang /studio)",
    ...
    opt_model_auto: "Tự động (Fast-Path Native + Fallback)",
    opt_model_kaggle: "Kaggle TPU/GPU (Qwen2.5-VL)",
    opt_model_gemini_flash: "Google Gemini 1.5 Flash Vision",
    opt_model_gemini_pro: "Google Gemini 1.5 Pro Vision",
  ...
  en: {
    ...
    demo_hint_title: "Evaluation Demo Credentials:",
    demo_admin_hint: "Admin: admin / Admin@123 (Auto-redirects to /admin)",
    demo_user_hint: "User: demo / Demo@123 (Auto-redirects to /studio)",
    ...
    opt_model_auto: "Automatic (Fast-Path Native + Fallback)",
    opt_model_kaggle: "Kaggle TPU/GPU (Qwen2.5-VL)",
    opt_model_gemini_flash: "Google Gemini 1.5 Flash Vision",
    opt_model_gemini_pro: "Google Gemini 1.5 Pro Vision",
    opt_model_groq: "Groq LLaMA 3.2 Vision",
